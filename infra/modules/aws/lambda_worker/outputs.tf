...
output "sqs_queue_url" {
  value = var.lambda_worker_queue_url
}

output "sqs_queue_name" {
  value = var.lambda_worker_queue_name
}

output "sqs_queue_read_policy_arn" {
  value = var.lambda_worker_queue_read_policy_arn
}

output "dead_letter_queue_url" {
  value = var.lambda_worker_dead_letter_queue_url
}
